...
```bash
curl -O https://raw.githubusercontent.com/caijq00/reinstall/main/reinstall.sh || wget -O ${_##*/} $_
```
...
- <https://raw.githubusercontent.com/caijq00/reinstall/main/reinstall.bat>
...
从 <https://github.com/caijq00/reinstall/commits/main> 右侧找到旧版本的 `commit_id`

```bash
commit_id=xxxxxxx
curl -O https://raw.githubusercontent.com/caijq00/reinstall/$commit_id/reinstall.sh || wget -O ${_##*/} $_
